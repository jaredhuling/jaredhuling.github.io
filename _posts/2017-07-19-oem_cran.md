...
## 	C:\Users\Jared\AppData\Local\Temp\RtmpA9lsE8\downloaded_packages
```
...
|--------------------+--------------------+--------------------------|
| Group MCP          | `grp.mcp`          | $\sum_{k = 1}^G p^{MCP}_{\lambda d_k,\gamma}(\vert \vert \boldsymbol\beta_{g_k}\vert \vert_2)$ |
|--------------------+--------------------+--------------------------|
| Group SCAD         | `grp.scad`         | $\sum_{k = 1}^G p^{SCAD}_{\lambda d_k,\gamma}(\vert \vert \boldsymbol\beta_{g_k}\vert \vert_2)$ |
|--------------------+--------------------+--------------------------|
...
\begin{array}{ll}
      ...
      -\frac{\vert\beta\vert^2 - 2\gamma\lambda\vert\beta\vert + \lambda^2}{2(\gamma - 1)} & \lambda < \vert\beta\vert \leq \gamma\lambda,  \\
      \frac{(\gamma + 1)\lambda^2}{2} & \vert\beta\vert > \gamma\lambda, \\
\end{array} 
\right. \]
...
\begin{array}{ll}
      -\lambda (\vert\beta\vert - \frac{\beta^2} {2 \lambda\gamma}) & \vert\beta\vert \leq \gamma\lambda,  \\
      \frac{ \lambda^2\gamma}{2} & \vert\beta\vert > \gamma\lambda. \\
\end{array} 
\right. \]
