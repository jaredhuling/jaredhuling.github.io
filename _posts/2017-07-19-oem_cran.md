...
## 	C:\Users\Jared\AppData\Local\Temp\Rtmp0CSzJ6\downloaded_packages
```
...
|--------------------+--------------------+--------------------------|
| Group MCP          | `grp.mcp`          | $\sum_{k = 1}^Gp^{MCP}_{\lambda d_k,\gamma}(\vert\vert\boldsymbol\beta_{g_k}\vert\vert_2)$ |
|--------------------+--------------------+--------------------------|
| Group SCAD         | `grp.scad`         | $\sum_{k = 1}^Gp^{SCAD}_{\lambda d_k,\gamma}(\vert\vert\boldsymbol\beta_{g_k}\vert\vert_2)$ |
|--------------------+--------------------+--------------------------|
